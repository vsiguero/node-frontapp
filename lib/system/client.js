System.register(["superagent", "./analytics", "./contacts", "./channels", "./error", "./inboxes", "./groups", "./teams"], function (exports_1, context_1) {
    "use strict";
    var request, analytics_1, contacts_1, channels_1, error_1, inboxes_1, groups_1, teams_1, FrontAppClient;
